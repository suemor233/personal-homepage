...
const PostsItem: FC<AggregateTopPost> = ({ images, title }) => {
  return (
    <a className="bg-white border rounded-md p-2  hover:border-gray-500 transition-all duration-200" href=''>
      <NextImage
        src={
      ...
      />
      <h4 className='mt-5 text-xl text-center'>{title}</h4>
    </a>
  )
}
